...
LAB_NAME = "lab_2"
TARGET_CHANNELS = ["EEG1", "EEG2", "EEG3", "EEG4"]
BAND_LOW = (0.5, 2.0)
BAND_REF = (0.5, 30.0)
...
def run_analysis(data_root: Path, out_dir: Path,
    ...
    csv_path = out_dir / "relative_power_lab2.csv"
...
def main():
    parser = argparse.ArgumentParser(description="Compute relative band power (0.5–2 Hz)/(0.5–30 Hz) for lab_2 EEG channels (EEG1, EEG2)")
