...
# Reuse color mapping from original synthetic exploration if available
try:
    from scripts.synthetic_data_exploration.helpers import SYN_SLEEP_STAGE_COLORS
...
RESULTS = Path("results") / "synthetic_exploration_2"
