...
if __name__ == "__main__":
    ...
    parser.add_argument("--method", "-m", default="train", help="Method to run (train | generate | explore_synthetic | sweep)")
    ...
    if method not in ["train", "generate", "explore_synthetic", "sweep"]:
