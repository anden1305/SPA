...
# python3 main.py -m train_vae -c src/config/run/cvaemarhmm/substages_gmm_w_artifact/substages_vae_12.yaml
python3 main.py -m train_vae -c src/config/run/cvaemarhmm/substages_marhmm/substages_marhmm_7.yaml
