#!/bin/bash
# subject_lab + tune winners, joint fold 4 only (2 jobs). Walltime 4h.
#
# Prereq:
...
for cfg in src/config/run/cvaeprior/cv4fold/subject_lab_tune_winners/joint/fold_4/{cgmvae,chmmgmvae}.yaml; do
...
echo "Results: results/cv4fold/subject_lab_tune_winners/{cgmvae,chmmgmvae}/joint/fold_4/"
