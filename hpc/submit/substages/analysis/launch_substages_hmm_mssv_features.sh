...
SWEEP_YAML="src/config/sweep/substages/substage_analysis/substages_hmm_mssv_features.yaml"
...
# Usage:
# bash hpc/submit/substages/analysis/launch_substages_hmm_mssv_features.sh
#
# Monitor with:
# bjobs
