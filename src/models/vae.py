...
class ConditionalVAE(nn.Module):
    ...
    def __initialize_weights(self):
        ...
        # NOTE: consider removing this ReLU for standardized inputs:
        # mlp.append(nn.ReLU())
        ...
        for i in range(len(rev_channels)):
            ...
            if i != len(rev_channels) - 1:
                ...
                dec_layers.append(nn.GroupNorm(num_groups=8, num_channels=out_ch))  # choose groups that divide out_ch
