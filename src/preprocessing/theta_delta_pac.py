...
class ThetaDeltaPAC(BaseTransform):
    """
    Theta–Delta Phase–Amplitude Coupling (Tort Modulation Index) per window & channel.

    Purpose:
      - Explores coupling between theta phase (6–10 Hz) and delta amplitude (0.5–4 Hz).
    ...
    def get_short_name(self):
        return "ThetaDeltaPAC"

    def __str__(self) -> str:
        return (
            "ThetaDeltaPAC(window_size="
