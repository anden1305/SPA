...
class ThetaBetaPAC(BaseTransform):
    """
    Theta–Beta Phase–Amplitude Coupling (Tort Modulation Index) per window & channel.

    Purpose:
      - Measures how theta phase (6–10 Hz) modulates beta amplitude (13–30 Hz).
      - Mirrors ThetaGammaPAC structure with different amplitude band.
