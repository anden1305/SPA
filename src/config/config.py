...
class ModelConfig(BaseModel):
    ...
    init_strategy: str = Field(default="random", pattern="^(random|random_separated|random_uniform|random_dirichlet|kmeans|kmeans_noisy|kmeans_pca|sticky_em_warmstart|kmeans_pca_warmstart)$")
